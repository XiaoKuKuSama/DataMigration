...
import com.ydx.datamigration.properties.YDXAgentSrvDataSourceConfigProperties;
...
/**
 * 易多销服务商库 agent_srv 数据源配置
 */
@Configuration
@MapperScan(basePackages = YDXAgentSrvDataSourceConfig.PACKAGE, sqlSessionFactoryRef = YDXAgentSrvDataSourceConfig.SQL_SESSION_FACTORY)
public class YDXAgentSrvDataSourceConfig {

    private static final Logger logger = LoggerFactory.getLogger(YDXAgentSrvDataSourceConfig.class);

    //项目定义的数据源名称
    protected final static String DATA_SOURCE = DataSourceConstants.YDX_AGENT_SRV_DATASOURCE_NAME;
    //数据源配置扫描包路径
    protected final static String PACKAGE = DataSourceConstants.YDX_AGENT_SRV_DATASOURCE_PACKAGE;
    ...
    @Autowired
    private YDXAgentSrvDataSourceConfigProperties properties;
