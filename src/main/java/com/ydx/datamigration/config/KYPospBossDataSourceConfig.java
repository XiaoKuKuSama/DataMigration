...
import com.ydx.datamigration.properties.KYPospBossDataSourceConfigProperties;
...
/**
 * 卡友运营库 posp_boss 数据源配置
 */
@Configuration
@MapperScan(basePackages = KYPospBossDataSourceConfig.PACKAGE, sqlSessionFactoryRef = KYPospBossDataSourceConfig.SQL_SESSION_FACTORY)
public class KYPospBossDataSourceConfig {
    private static final Logger logger = LoggerFactory.getLogger(KYPospBossDataSourceConfig.class);

    //项目定义的数据源名称
    protected final static String DATA_SOURCE = DataSourceConstants.KY_POSP_BOSS_DATASOURCE_NAME;
    //数据源配置扫描包路径
    protected final static String PACKAGE = DataSourceConstants.KY_POSP_BOSS_DATASOURCE_PACKAGE;
    ...
    @Autowired
    private KYPospBossDataSourceConfigProperties properties;
