...
import com.ydx.datamigration.properties.YDXAgentProductDataSourceConfigProperties;
...
/**
 * 易多销服务商产品库 agent_product 数据源配置
 */
@Configuration
@MapperScan(basePackages = YDXAgentProductDataSourceConfig.PACKAGE, sqlSessionFactoryRef = YDXAgentProductDataSourceConfig.SQL_SESSION_FACTORY)
public class YDXAgentProductDataSourceConfig {
    private static final Logger logger = LoggerFactory.getLogger(YDXAgentProductDataSourceConfig.class);

    //项目定义的数据源名称
    protected final static String DATA_SOURCE = DataSourceConstants.YDX_AGENT_PRODUCT_DATASOURCE_NAME;
    //数据源配置扫描包路径
    protected final static String PACKAGE = DataSourceConstants.YDX_AGENT_PRODUCT_DATASOURCE_PACKAGE;
    ...
    @Autowired
    private YDXAgentProductDataSourceConfigProperties properties;
